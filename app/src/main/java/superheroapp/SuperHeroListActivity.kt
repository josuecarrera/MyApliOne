...
import com.example.myaplione.databinding.ActivitySuperHeroListBinding
    ...
    private fun searchByName(query: String) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (myResponse.isSuccessful) {
                Log.i("myaplione", "Si funciona")
                val response: SuperHeroDataResponse? = myResponse.body()
                if (response != null) {
                    Log.i("miaplione", response.toString())
                    runOnUiThread {
